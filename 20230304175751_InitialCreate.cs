...
namespace Danskebank_API.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductSubtypeID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProductSubtypeName = table.Column<string>(type: "TEXT", nullable: false),
                    TypeID = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSubtypes", x => x.ProductSubtypeID);
                    table.ForeignKey(
                        name: "FK_ProductSubtypes_ProductTypes_TypeID",
                        column: x => x.TypeID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSubtypes_TypeID",
